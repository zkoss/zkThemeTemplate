...
### D48 — Live-reload for the javax host (row 2.5) — **PROPOSED 2026-09-11 (chat D56): drop it; the statement lands in `zk`'s copy of the skill, not in the template original**
