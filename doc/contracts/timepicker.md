...
| c15 | `.z-timepicker-readonly .z-timepicker-input` | cursor | `pointer` | readonly is interactive (the popup opens) → active affordance, not disabled; only `cursor:pointer` signals the popup. See doc/combo-readonly-consistency-audit.md + ZK-6122. |
