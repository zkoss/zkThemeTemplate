...
| c11a | `.z-tabbox-accordion .z-tab-button` | display | `none` — accordion NEVER shows the close icon, regardless of `closable` (corrected 2026-06-07, failing-first; supersedes the iceblue-baseline "visible, no override" ruling — accordion = MD3 expansion panel, which has no inline dismiss affordance, `doc/md3-close-affordance-placement.md`) | user ruling 2026-06-07 |
