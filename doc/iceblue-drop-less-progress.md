...
- **[L3 技術附錄](#l3-技術附錄獨立檔)** — 索引在本檔;**內容在 [iceblue-drop-less-progress-appendix.md](iceblue-drop-less-progress-appendix.md)**
  ...
  - [L3-I Change Log](iceblue-drop-less-progress-appendix.md#l3-i-change-log--狀態層的敘述更正) — 47 條狀態層更正
...
> **三支複核現在同時 exit 0**(紀錄 #54)。第 4 層獨立驗證 **C1–C11 全部 CONFIRMED**,
...
| **M3** vendor prefix 政策(P4a · P4b) | **1 / 2 DONE** | **L-2 已於 2026-08-07 拍板(選項 C:`-webkit-` 全數保留)**。**P4a DONE(同日)** —— 728 條 / 45 檔純移除,G-delta 由 `check:p4a` 六項斷言收下,`-webkit-` 313 條與 B 群 44 條原封不動;**P4b(15 條逐條判斷)TODO** |
...
| **[L3-A](iceblue-drop-less-progress-appendix.md#l3-a-閘門紀錄附加式不覆寫)** | **閘門紀錄 55 列**(附加式,**不覆寫**) | P8 核帳、以及要確認某個數字是哪一次跑出來的 |
