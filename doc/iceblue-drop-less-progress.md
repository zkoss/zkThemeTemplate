...
| 階段 | 卡在什麼 |
|---|---|
| P7 | L-4 —— compact profile 的替代機制未定(**colour 那一半已解除**,density 那一半仍未定)。**←2026-08-12 進度**:機制已有完整計畫書 [tasks/l4-density-mechanism.md](../tasks/l4-density-mechanism.md)(`data-density` 屬性 + 350 條 token 覆寫,D1–D5),4 項未決**已裁示 1 項**(屬性字彙 `default` / `compact`)。**P7 的解除條件是「L-4 拍板」,不是「D1–D5 做完」** —— P7 只需要知道 compact 走 runtime 屬性(而非 build 期換 jar),就能決定 tablet 要怎麼轉 |
