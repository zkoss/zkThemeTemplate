/* WCAGNavyCompactThemeWebAppInit.java
...
*/
package org.zkoss.theme.wcag_navy_c;
 ...
 * 
 */
public class WCAGNavyCompactThemeWebAppInit implements WebAppInit {

	private final static String THEME_NAME = "wcag_navy_c";
	private final static String THEME_DISPLAY = "WCAG Navy Compact";
