...
*/
package org.zkoss.theme.iceblue;
 ...
 * 
 */
public class IceblueThemeWebAppInit implements WebAppInit {

	private final static String THEME_NAME = "iceblue";
	private final static String THEME_DISPLAY = "Iceblue";
