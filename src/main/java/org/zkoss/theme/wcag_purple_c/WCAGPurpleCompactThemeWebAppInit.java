/* WCAGPurpleCompactThemeWebAppInit.java
...
*/
package org.zkoss.theme.wcag_purple_c;
 ...
 * 
 */
public class WCAGPurpleCompactThemeWebAppInit implements WebAppInit {

	private final static String THEME_NAME = "wcag_purple_c";
	private final static String THEME_DISPLAY = "WCAG Purple Compact";
