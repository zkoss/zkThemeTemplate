 ...
 * 
 */
public class ScaThemeWebAppInit implements WebAppInit {

	private final static String THEME_NAME = "sca";
	private final static String THEME_DISPLAY = "SCA Logistics custom ZK theme";
