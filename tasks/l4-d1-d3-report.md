...
* [x] ~~**D5 收尾**(等 D4)~~ ── **2026-08-17 完工**:`readme.md` 兩章改寫、對外遷移指南
      [migration/density.md](../doc/migration/density.md)、**S36 以 S62 正式結案**。

> **本節其餘未打勾的項目都已在別處結案,這份報告是當時的快照,不是活的追蹤表** ——
> 裁示議題二於 2026-08-14 拍板(L-4 採用),D4 於 2026-08-17 完工(機制與驗收都改了,見 C23)。
> density 這條線的現況一律以 [l4-density-mechanism.md](l4-density-mechanism.md) 的里程碑表為準。
